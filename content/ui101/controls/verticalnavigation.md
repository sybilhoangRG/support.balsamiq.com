...
* [Use titles](https://developer.apple.com/macos/human-interface-guidelines/windows-and-views/sidebars/ "macOS Human Interface Guidelines") to form logical groupings of related items.
* Clicking or tapping on category labels should expand or collapse that category rather than linking to its own page.
* [Keep the navigation links short.](https://standards.usa.gov/components/sidenav/ "U.S. Web Design Standards") They can be shorter derivatives of page titles themselves. 
* [Order the list according to what is most useful](https://developer.gnome.org/hig/stable/sidebar-lists.html.en "GNOME Human Interface Guidelines") for the users of your application. 
* Having hierarchical data doesn't mean that you must use a tree view. [Very often a list view is a simpler, yet more powerful choice.](https://msdn.microsoft.com/en-us/library/windows/desktop/dn742445(v=vs.85).aspx "Microsoft Windows Desktop Guidelines") 
* In general, [refrain from exposing more than two levels of hierarchy within a sidebar.](https://developer.apple.com/macos/human-interface-guidelines/windows-and-views/sidebars/ "macOS Human Interface Guidelines")
