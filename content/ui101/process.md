...
The process described in this chapter is the result of many interviews with entrepreneurs, product managers, UX designers, marketers and developers. Every organization is a little different, but we think that what we describe can serve as a useful starting point for you and your team.

The process is a little different if you're not creating something completely new but are instead adding a small feature to an existing software or website. It's also a little different wether you're a product company or a consulting company.
...
Useful links to learn more about requirement gathering:
...
Some software teams like to do this part together in a meeting room with a whiteboard, or by using real-time-collaboration in Balsamiq Cloud. Other teams like to do an exercise where multiple people come up with solutions on their own, and then get together to review them and pick the best elements of each.
...
If you can't draw a straight line to save your life, or find a white page intimidating because it allows you too much freedom (which might make your design too hard to implement), a tool like Balsamiq is perfect for you. You can just pick standard elements from the UI Library and assemble them. Make sure you use the [Sketch skin](https://docs.balsamiq.com/desktop/) for this step! Switching to the wireframe skin or - God forbid - using a tool that allows you to design at high fidelity, **is a terrible mistake** at this point! Unless you have superhuman self-control, you'll find yourself going WAY too far ahead, fiddling with details like colors, fonts, and pixel-perfect alignments. That's a huge waste of time right now.

If you're just adding a piece of functionality to an existing user interface, you might find it faster to take a screenshot of the existing UI and tweaking it by using the crop image tool. Here's a [tutorial specifically about this topic](/wiki/pages/createpage.action?spaceKey=intranet&title=tutorial+specifically+about+this+topic&linkCreation=true&fromPageId=357532316). We're also working on [a magical feature](https://www.youtube.com/watch?v=5SxuZsEu3No) which will help you go from screenshot back to low-fidelity with one click.

Now it's the time to use all the tips and techniques you learned about in the [previous chapters](/wiki/pages/createpage.action?spaceKey=intranet&title=previous+chapters&linkCreation=true&fromPageId=357532316).

Don't be afraid to start over! Balsamiq offers [unlimited wireframes](/wiki/pages/createpage.action?spaceKey=intranet&title=unlimited+wireframes&linkCreation=true&fromPageId=357532316), [unlimited Undo](/wiki/pages/createpage.action?spaceKey=intranet&title=unlimited+Undo&linkCreation=true&fromPageId=357532316), [Alternates](/wiki/pages/createpage.action?spaceKey=intranet&title=Alternates&linkCreation=true&fromPageId=357532316) and [Project History](/wiki/pages/createpage.action?spaceKey=intranet&title=Project+History&linkCreation=true&fromPageId=357532316), so you can easily create different versions and go back in time if you need to.
...
Once you're at a good stopping point, **take a hot shower, or a quick nap!** \- the warm and cozy environment away from the computer will help your brain digest what you just did and suggest changes and improvements.
...
If you want to show the whole vision to the team, add some annotations that say "v.2" or "this can come later". I like to use yellow Pointy Buttons controls for those, or Vertical Curly Braces.
...
Once again, use everything you've learned in the [previous chapters](/wiki/pages/createpage.action?spaceKey=intranet&title=previous+chapters&linkCreation=true&fromPageId=357532316) to create wonderfully usable, lovable designs.
...
You might want to use the [Symbols](/wiki/pages/createpage.action?spaceKey=intranet&title=Symbols&linkCreation=true&fromPageId=357532316) feature for headers and footers, and you might want to [link screens together](/wiki/pages/createpage.action?spaceKey=intranet&title=link+screens+together&linkCreation=true&fromPageId=357532316) to help you walk through them - though it's generally not required as long as you [sort your wireframes](/wiki/pages/createpage.action?spaceKey=intranet&title=sort+your+wireframes&linkCreation=true&fromPageId=357532316) in a way that flows naturally.

We believe that it's important at this point to **allow others to participate in the wireframing process**. Just because their job title says "developer" or "business person" ![(wink)](/wiki/s/198691115/6452/4d4a00afa6a41598cf0f96a15507d1d935df7796/_/images/icons/emoticons/wink.png "(wink)") it doesn't mean that their user interface ideas should be discounted. We built Balsamiq specifically to allow non-designers to have a seat at the table. You're probably not a professional designer yourself, so don't get protective and invite others who are interested in sharing their user interface ideas to your project! In Balsamiq Cloud for instance, you can do this [very easily](/wiki/pages/createpage.action?spaceKey=intranet&title=very+easily&linkCreation=true&fromPageId=357532316). They can work alongside of you, creating alternate versions for you to review, and you can easily [comment on their designs](/wiki/pages/createpage.action?spaceKey=intranet&title=comment+on+their+designs&linkCreation=true&fromPageId=357532316) so you can iterate together.
...
*   this course ![(smile)](/wiki/s/198691115/6452/4d4a00afa6a41598cf0f96a15507d1d935df7796/_/images/icons/emoticons/smile.png "(smile)")
...
This will be more of a sales meeting than a brainstorming meeting. You will be pitching your design to all the stake-holders, confident that it will satisfy the requirements. You will still accept feedback, but don't expect too much of it.
...
One trick that some of our customers use at this point is to switch to the Wireframe skin. It's still low-fidelity, but it's a bit more polished, just enough not to elicit the same amount of feedback as the Sketch one. ![(smile)](/wiki/s/198691115/6452/4d4a00afa6a41598cf0f96a15507d1d935df7796/_/images/icons/emoticons/smile.png "(smile)")

Walk people through each of the screens you designed, one by one. Try to keep the presentation engaging: avoid getting bogged down in too many details. If objections occurr, make a note of them and promise deal with them 1 on 1 after the meeting (if possible).
...
Some, usually large companies use high fidelity prototype to get buy in from executives. The idea is that in the enterprise world, _the suits_ don't want to see low fidelity, sketchy-looking stuff. They want to see the real thing, it all of its branding glory. ![(smile)](/wiki/s/198691115/6452/4d4a00afa6a41598cf0f96a15507d1d935df7796/_/images/icons/emoticons/smile.png "(smile)")
...
If your process is different, [tell us about it](/wiki/pages/createpage.action?spaceKey=intranet&title=tell+us+about+it&linkCreation=true&fromPageId=357532316)! We're always happy to improve these guides.